...
class KuisonerDataTable extends DataTable
{
    /**
     ...
     *
     * @param \App\App\Models\Admin\Kuisoner\KuisonerDataTable $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(Kuisoner $model)
    {
    ...
    {
        return 'Admin\Kuisoner\Kuisoner_' . date('YmdHis');
    }
}
